...
function mapExcluded(day: BasinForm["excludedDays"][number]) {
  const typeValue =
...
export function buildBasinHtSaveData(
  form: BasinForm,
  result: CalcSaveResult & Partial<BasinHtSaveExtras>,
  ...
  const haftaTatiliData = {
    ...
    katsayi,
    isGeceCalisan: form.geceCalisan,
