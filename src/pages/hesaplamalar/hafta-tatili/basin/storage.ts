...
import { createEmptyForm, type BasinForm, type SavedCase } from "./model";

export const STORAGE_KEY = "bilirkisi-hesap-v35:hafta-tatili-basin:cases:v1" as const;
...
function normalizeForm(raw: Partial<BasinForm> | undefined | null): BasinForm {
...
export function saveCase(name: string, form: BasinForm, results: SavedCase["results"], existingId?: string | null): SavedCase | null {
