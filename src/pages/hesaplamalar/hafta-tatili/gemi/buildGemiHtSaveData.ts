...
function mapExcluded(day: GemiForm["excludedDays"][number]) {
  const typeValue =
...
export function buildGemiHtSaveData(
  form: GemiForm,
  result: CalcSaveResult & Partial<GemiHtSaveExtras>,
