/**
 * Tanıklı Standart Fazla Mesai — UBGT (Ulusal Bayram ve Genel Tatil) gün kataloğu.
 * Statik, tamamen lokal bir kopyadır (ağ isteği yoktur); tarihler resmî tatil
 * takvimiyle uyumludur. Bu dosya yalnızca bu klasöre aittir; başka fazla mesai
 * alt türleriyle paylaşılmaz (izole kopya).
 *
