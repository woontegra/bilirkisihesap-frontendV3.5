/**
 * Tanıklı Standart Fazla Mesai — sabitler (İş Kanunu md. 41 ve ilgili
 * yönetmelik). Bu dosya yalnızca `fazla-mesai/tanikli-standart` klasörüne
 * aittir; `fazla-mesai/standart` dahil başka bir alt türle paylaşılmaz.
 */
