/**
 * Dönemsel Fazla Mesai — Kat Sayı Hesapla modalı (V3 paritesi).
 * Bilinen ücret / asgari ücret oranından katsayı üretir (4 hane).
 */

import { useEffect, useMemo, useState } from "react";
import { Button } from "@/components/ui/Button";
import { parseNum, sanitizeMoneyTyping } from "./engine";
...
export function KatsayiModal({
  ...
  const katsayi = useMemo(() => {
    const known = parseNum(bilinenUcret);
    const min = parseNum(asgariUcret);
