/**
 * Dönemsel Fazla Mesai — Mahsuplaşma Ekle modalı (V3 paritesi).
 * Cetveldeki yıllar için ay bazında tutar girilir; toplam, mahsup tutarına yazılır.
 */

import { useEffect, useMemo, useState } from "react";
import { Button } from "@/components/ui/Button";
import { fmtCurrency, parseNum, sanitizeMoneyTyping } from "./engine";
    ...
    <div className={styles.modalOverlay} role="presentation" onClick={onClose}>
      ...
      >
        ...
        <p className={styles.modalDesc}>
          Ay ve yıl bazında mahsuplaşma miktarlarını girin; toplam tutar mahsup alanına aktarılır.
        </p>
                    ...
                    {years.map((year) => (
                      <td key={year}>
                        <input
                          ...
                          placeholder="0"
                          aria-label={`${name} ${year} mahsup tutarı`}
                        />
                      </td>
                    ))}
                  </tr>
