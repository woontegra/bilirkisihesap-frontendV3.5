/**
 * Tanıklı Standart Fazla Mesai — gelir vergisi (ücretliler) kademeli tarife tablosu, 2010–2030.
 * Yalnızca bu klasöre ait yerel bir kopyadır (değerler resmî GİB tebliğleriyle uyumludur);
 * başka bir fazla mesai alt türüyle paylaşılmaz ve hiçbir dosyadan import edilmez.
 */
