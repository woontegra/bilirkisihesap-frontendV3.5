...
import type { ExclusionItem, PeriodRow, WeeklyKarmaFmContext } from "./model";
  ...
  rows.forEach((row, rowIdx) => {
    ...
    windows.forEach((win, winIdx) => {
      ...
      out.push({
        ...
        karmaFmContext: row.karmaFmContext as WeeklyKarmaFmContext | undefined,
      });
    });
  });
