/**
 * Fazla Mesai — 24 Saat Vardiya — sabitler.
 */

export const FM_HOURS_PER_WORKDAY = 3;
export const FM_KATSAYI = 1.5;
export const FM_DENOMINATOR = 225;

export const WEEK_CAP_FULL_YEAR = 52;
export const WEEK_CAP_HALF_YEAR = 26;
