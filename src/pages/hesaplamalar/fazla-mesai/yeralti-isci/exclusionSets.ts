/**
 * Yeraltı İşçisi Fazla Mesai — dışlanabilir gün setlerinin lokal (bu tarayıcıya
 * özel) kaydı. Tamamen lokaldir; ağ isteği yoktur.
 */

import type { ExclusionItem } from "./model";
import { newLocalId } from "./model";

const KEY = "bilirkisi-hesap-v35:fm-yeralti:exclusion-sets:v1" as const;
