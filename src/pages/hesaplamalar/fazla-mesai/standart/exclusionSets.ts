/**
 * Standart Fazla Mesai — dışlanabilir gün setlerinin lokal (bu tarayıcıya özel)
 * kaydı. V3'teki backend tabanlı `/api/exclusion-sets` yerine, V3.5'in "hesaplama
 * yalnızca bu cihazda yapılır" ilkesiyle uyumlu, tamamen lokal bir depodur.
 */

import type { ExclusionItem } from "./model";
import { newLocalId } from "./model";

const KEY = "bilirkisi-hesap-v35:fm-standart:exclusion-sets:v1" as const;
