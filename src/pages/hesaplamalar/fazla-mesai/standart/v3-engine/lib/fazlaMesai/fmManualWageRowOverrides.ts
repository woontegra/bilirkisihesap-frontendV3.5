...
import { FM_MANUAL_BRUT_PERIOD_PREFIX, fmManualBrutPeriodOverrideKey } from "./tableDisplayPipeline";
...
// @ts-nocheck — V3'ten birebir kopya; yalnız import yolları güncellendi.
