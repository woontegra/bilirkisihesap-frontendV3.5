/**
 * İhbar Tazminatı — Gemi Adamları. Form/not/kayıt modelleri.
...
export type SavedCase = SavedIhbarCase<IhbarGemiForm, IhbarResultSnapshot>;

export function createEmptyForm(): IhbarGemiForm {
  return { startDate: "", endDate: "", brut: "", prim: "", ikramiye: "", yol: "", yemek: "", extras: [] };
}

export function normalizeForm(raw: Partial<IhbarGemiForm> | undefined | null): IhbarGemiForm {
...
export function snapshotKey(form: IhbarGemiForm): string {
