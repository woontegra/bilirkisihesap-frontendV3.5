/**
 * İhbar Tazminatı — Belirli Süreli İş Sözleşmesi. Form/not/kayıt modelleri.
...
export type SavedCase = SavedIhbarCase<IhbarBelirliForm, IhbarResultSnapshot>;

export function createEmptyForm(): IhbarBelirliForm {
  return { startDate: "", endDate: "", brut: "", prim: "", ikramiye: "", yol: "", yemek: "", extras: [] };
}

export function normalizeForm(raw: Partial<IhbarBelirliForm> | undefined | null): IhbarBelirliForm {
...
export function snapshotKey(form: IhbarBelirliForm): string {
