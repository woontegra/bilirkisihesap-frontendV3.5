/**
 * İhbar Tazminatı — Belirli Süreli İş Sözleşmesi. Lokal hesap motoru.
...
import type { IhbarBelirliForm } from "./model";

export { formatMoney, parseNum, clampYear, formatDateTR, isDateOrderInvalid };

export type IhbarBelirliResult = {
...
export function computeIhbarBelirliResult(form: IhbarBelirliForm): IhbarBelirliResult {
