/**
 * İhbar Tazminatı — Borçlar Kanunu. Form/not/kayıt modelleri.
...
export type SavedCase = SavedIhbarCase<IhbarBorclarForm, IhbarResultSnapshot>;

export function createEmptyForm(): IhbarBorclarForm {
  return { startDate: "", endDate: "", brut: "", prim: "", ikramiye: "", yol: "", yemek: "", extras: [] };
}

export function normalizeForm(raw: Partial<IhbarBorclarForm> | undefined | null): IhbarBorclarForm {
...
export function snapshotKey(form: IhbarBorclarForm): string {
