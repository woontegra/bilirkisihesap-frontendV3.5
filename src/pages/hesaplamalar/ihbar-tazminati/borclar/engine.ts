/**
 * İhbar Tazminatı — Borçlar Kanunu. Lokal hesap motoru.
...
import type { IhbarBorclarForm } from "./model";

export { formatMoney, parseNum, clampYear, formatDateTR, isDateOrderInvalid };

export type IhbarBorclarResult = {
...
export function computeIhbarBorclarResult(form: IhbarBorclarForm): IhbarBorclarResult {
