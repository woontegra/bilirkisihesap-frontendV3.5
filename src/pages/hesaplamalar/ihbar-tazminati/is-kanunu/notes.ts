/**
 * İhbar Tazminatı — İş Kanununa Göre. Hukuki notlar.
 * Kaynak: FrontendV3/src/calculations/ihbar-tazminati/Ihbar30Page.tsx (İş Kanunu m.17).
 */
...
export const NOTE_BLOCKS: NoteBlock[] = [
  ...
  {
    text: "c) İşi birbuçuk yıldan üç yıla kadar sürmüş işçi için, bildirimin diğer tarafa yapılmasından başlayarak altı hafta sonra,",
    kind: "li",
  },
  {
