/**
 * İhbar Tazminatı — İş Kanununa Göre (30+ işçi). Lokal hesap motoru.
...
export function computeIhbar30IsciResult(form: Ihbar30IsciForm): Ihbar30IsciResult {
