/**
 * Gemi Adamları — asgari brüt ücret tablosu (dönemsel).
 * Değerler V3 KidemTazminatiForm / shared asgariUcretler ile doğrulanmıştır.
 * Uyarı yalnızca bilgilendirme amaçlıdır; hesabı engellemez.
 */
