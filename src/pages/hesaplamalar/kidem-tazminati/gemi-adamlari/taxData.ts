/**
 * Gemi Adamları — ücretliler gelir vergisi tarifesi (v1).
 * Veri kaynağı: frontendV3/src/shared/utils/incomeTaxCore.ts (incomeTaxRates).
 * Bu dosya sadece veriyi kendi yapısına göre yeniden yazar; koddan içe aktarma yoktur,
 * yalnızca bu modül tarafından kullanılır.
 */

export const TAX_DATA_VERSION = 1 as const;

export type GemiTaxBracket = {
  limit: number | null;
  rate: number;
  baseTax: number;
  baseLimit: number;
...
const BRACKETS_2026_PLUS: GemiTaxBracket[] = [
...
export const GEMI_INCOME_TAX_BRACKETS: Record<number, GemiTaxBracket[]> = {
  2030: BRACKETS_2026_PLUS,
  2029: BRACKETS_2026_PLUS,
  2028: BRACKETS_2026_PLUS,
  2027: BRACKETS_2026_PLUS,
  2026: BRACKETS_2026_PLUS,
  2025: [
