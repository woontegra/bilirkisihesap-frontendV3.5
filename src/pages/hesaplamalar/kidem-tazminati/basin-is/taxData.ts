/**
 * Kıdem Tazminatı — Basın İş — gelir vergisi dilimleri (2010–2025).
 *
 * ÖNEMLİ: Bu veri, davacı ücreti / diğer kıdem modüllerindeki paylaşılan gelir
 * vergisi tablosundan BAĞIMSIZDIR ve bilerek AYRI tutulur. Basın İş (5953 sayılı
 * Kanun) sayfasının v1 davranışıyla birebir eşleşmesi için 2021 dilimleri diğer
 * modüllerden farklıdır (limit 130.000 / taban vergi 9.400 vb.). Kaynak:
 * frontendV3/src/calculations/kidem-tazminati/incomeTaxForYear.ts — bu modül için
 * bilerek kopyalanmıştır, ithal edilmemiştir (izolasyon kuralı).
 */
...
export const INCOME_TAX_BRACKETS: Record<number, TaxBracket[]> = {
  ...
  // NOT: Basın İş'e özgü 2021 dilimleri — diğer kıdem/davacı modüllerinden
  // FARKLIDIR (paylaşılan tabloda limit 190.000 / taban 9.400 iken burada 130.000 / 9.400'dür).
  2021: [
