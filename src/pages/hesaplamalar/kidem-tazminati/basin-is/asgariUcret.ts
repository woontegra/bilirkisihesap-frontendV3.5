/**
 * Asgari brüt ücret tablosu (V3 KidemTazminatiForm ASGARI_UCRET_BRUT ile aynı).
 * Yalnızca çıplak brüt uyarısı için; hesabı engellemez.
 */
...
/** İşten çıkış tarihine göre dönem asgari brütünü döner. */
