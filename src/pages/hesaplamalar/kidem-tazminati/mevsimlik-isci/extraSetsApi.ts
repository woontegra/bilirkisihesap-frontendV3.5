/**
 * Mevsimlik İşçi — kaydedilmiş ekstra hesaplama setleri API katmanı.
 *
 * V3 ile aynı sözleşme:
 *   GET    /api/extra-calculations-sets
 *   POST   /api/extra-calculations-sets  { name, data }
 *   DELETE /api/extra-calculations-sets/:id
 *
 * Yalnızca set CRUD için ağ kullanılır. Hesaplama motoru bu dosyayı import etmez.
 */
...
/** Set oluşturur veya aynı isimdeyse günceller (V3 POST; ayrı PUT yok). */
