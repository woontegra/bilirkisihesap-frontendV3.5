/**
 * İhbar Tazminatı — lokal asgari ücret tablosu (uyarı için).
 * `ise-almama-tazminati/asgariUcret.ts` dosyasının yerel bir kopyasıdır; yalnızca ihbar-tazminati
 * modülü içinde paylaşılır ve başka bir hesaplama modülünden import edilmez.
 */
