...
import type { YillikMevsimForm } from "../mevsim/model";
...
export function buildMevsimYillikPreviewSections(opts: {
  form: YillikMevsimForm;
  ...
  const sections: PreviewSection[] = [
    {
      ...
      headers: ["Alan", "Değer"],
      rows: [
        ["İşe Giriş Tarihi (ilk dönem)", formatDateTR(form.startDate)],
        ["İşten Çıkış Tarihi (son dönem)", formatDateTR(form.endDate)],
