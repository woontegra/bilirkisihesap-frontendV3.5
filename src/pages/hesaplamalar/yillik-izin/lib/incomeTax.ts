/**
 * Yıllık Ücretli İzin — gelir vergisi (ücretliler) kademeli tarife tablosu, 2010–2030.
...
/** Backend `calculateIncomeTaxForYear` — basın günlük olmayan yolunda kullanılır. */
