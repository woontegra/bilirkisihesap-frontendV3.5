/**
 * Ayrımcılık Tazminatı — gelir vergisi (ücretliler) kademeli tarife tablosu, 2010–2030.
 * İhbar Tazminatı `incomeTax.ts` ile birebir aynı pipeline (lump-sum / dilim / yuvarlama).
 * Yalnızca bu klasörde kullanılır; başka hesaplama sayfasından import edilmez.
 */
