/**
 * Boşta Geçen Süre Ücreti — gelir vergisi (ücretliler) kademeli tarife tablosu, 2010–2030.
 * `fazla-mesai/standart/incomeTax.ts` dosyasının yerel bir kopyasıdır;
 * yalnızca bu modül içinde kullanılır, başka bir hesaplama modülünden import edilmez.
 */
...
/** Backend `calculateIncomeTaxForYear` — baseTax + (matrah - baseLimit) * rate */
