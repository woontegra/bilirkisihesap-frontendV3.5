/**
 * Haksız Fesih Tazminatı — versiyonlu lokal depo.
...
export const STORAGE_KEY = "bilirkisi-hesap-v35:haksiz-fesih-tazminati:cases:v1" as const;

type CasesPayload = { version: 1; cases: SavedCase[] };

export type LoadResult<T> = { ok: true; items: T[] } | { ok: false; items: T[]; reason: string };

function isForm(v: unknown): v is HaksizFesihForm {
